...
<div id="showdata" class="content_users">
  ...
  <table id="tabledata">
	...
	<td ><input id-product="<?php echo $product['id'];  ?>" type="checkbox"></td>
...
?>
	...
	<div  class="form-popup" id="delete_confirmation">
		<p>Are you sure that you want to delete those Products</p>
...
<form id="formElement"   class="productFormall" action="upload.php" method="POST" >
	...
	<script src="deleteProducts\delete.js"></script> 
